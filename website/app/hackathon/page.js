...
import { ArrowRight, BookOpen, Layers, CheckCircle2, Home, Database, RefreshCw, Timer } from 'lucide-react';
      ...
      <main className="pt-8 pb-24">
        ...
        <section className="max-w-5xl mx-auto px-6 text-center space-y-8">
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto leading-relaxed">
            A Hifz companion that connects memorization with meaning: reading,
            tafsir, planning, sessions, and review in one measured flow.
          </p>
        ...
        <section className="max-w-5xl mx-auto px-6 mt-24">
          <div className="w-full rounded-2xl border border-white/10 bg-white/5 p-8 md:p-10 shadow-[0_0_50px_rgba(255,255,255,0.05)]">
            <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-white/40 mb-3">Submission surface</p>
                <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-3">
                  The homepage is the main hackathon story.
                </h2>
                <p className="text-white/60 leading-relaxed">
                  Reviewers should land on the same product narrative users see:
                  Read, Understand, Memorize. This page stays as a concise
                  technical appendix for API usage and judging context.
                </p>
              </div>
              <Link href="/" className="h-12 px-8 rounded-full bg-white text-black flex items-center justify-center gap-2 font-medium hover:bg-white/90 transition-colors">
                Open Homepage
        ...
        <section className="max-w-5xl mx-auto px-6 mt-32 space-y-16">
          <div className="text-center space-y-4">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              Jawhar uses Quran Foundation APIs where they strengthen the core
              experience: reliable Quran content, contextual study, and account
              continuity for users who choose to sync.
            </p>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-6 mt-32">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 border border-white/10 rounded-2xl">
              ...
              <p className="text-sm text-white/60">Adaptive daily plans (Sabaq, Sabqi, Manzil) sized to the learner&apos;s pace and review needs.</p>
            </div>
            <div className="p-6 border border-white/10 rounded-2xl">
              <Timer className="w-6 h-6 mb-4 text-white/60" />
