                ...
                return Directionality(
                  ...
                  child: PageView.builder(
                    ...
                    onPageChanged: (index) {
                      ...
                      // Prefetch adjacent page translations
                      context.read<ContextProvider>().prefetchAdjacentPages(
                        page,
                      );
                    },
                        ...
                        child: Column(
                          ...
                          children: [
                            AudioPlayerBridge(
                              ...
                              onJumpForward: () =>
                                  audioProvider.seekForward(10),
                              onJumpBackward: () =>
                                  audioProvider.seekBackward(10),
                              onRepeatToggle: () =>
                                  audioProvider.toggleRepeatMode(),
                              onSeek: (val) =>
                                  audioProvider.seekToFraction(val),
                            ),
                            BottomDock(
...
class QuranPageState extends State<QuranPage>
  ...
  void _scrollToVerse(
    ...
    if (!allMeasured) {
      AppLogger.warn(
        'TafsirScroll',
        'Mobile Scroll index $index ($verseKey): waiting for measurements...',
      );
      Future.delayed(
        const Duration(milliseconds: 50),
        () => _scrollToVerse(index, verseKey, theme, translations),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context)?.pageLoadError(widget.pageNumber) ??
        ...
        children: [
          ...
          Builder(
            builder: (ctx) {
              ...
              if (!ctxProvider.translationEnabled ||
  ...
  /// Verse-by-verse translation view: Arabic text + translation for each verse.
  ...
  Widget _buildTafsirView(ThemeProvider theme) {
    ...
    if (translations.isEmpty &&
        !contextProvider.isPageLoading(widget.pageNumber)) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) {
    ...
    if (contextProvider.isPageLoading(widget.pageNumber) &&
    ...
    if (scrollKey != null &&
        scrollKey != _lastScrolledVerseKey &&
        _verses != null) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        // Verse actions row (Play, Tafsir, Reason on left; Badge on right)
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Row(
