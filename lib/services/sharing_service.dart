        ...
        build: (context) => [
          ...
          pw.TableHelper.fromTextArray(
            ...
            data: [
              ...
              ['Start Date', profile.startDate.toString().split(' ').first],
            ],
          ),
          ...
          pw.Text(
            'Generated by Jawhar — Memorize with Meaning',
...
enum MilestoneType { juzComplete, khatmComplete, streakMilestone }
