...
class OfflineFallbackService {
  ...
  OfflineFallbackService(HifzDatabaseService db)
    : _planService = PlanGenerationService(db);
  ...
  Future<Map<String, dynamic>> generateFallback({
    ...
    return {
      'plan': {
        ...
        'sabqi': {'pages': dailyPlan.sabqiPages},
        'manzil': {'juz': dailyPlan.manzilJuz, 'pages': dailyPlan.manzilPages},
      },
      'recipes': recipes,
      ...
      'frameworkParams': {
        'dailySabaqLoad':
            '${dailyPlan.sabaqLineEnd - dailyPlan.sabaqLineStart + 1} lines',
      ...
      return {
        'steps': [
          _step(
            1,
            'listen',
            'Listen to the reciter read lines $lineRange of $pageRef. Just relax and follow along.',
            3,
            'times',
            'headphones',
          ),
          _step(
            2,
            'read_along',
            'Read along with the audio at a comfortable pace.',
            2,
            'times',
            'book_open',
          ),
          _step(
            3,
            'recite_memory',
            'Try reciting from memory. No pressure — see what you remember.',
            2,
            'times',
            'brain',
          ),
        ...
        'estimatedMinutes': 15,
        'tips': [
          'Welcome back! Today is about reconnecting, not perfection.',
          'Take it slow — momentum builds naturally.',
        ],
      };
    }
        ...
        return {
          'steps': [
            _step(
              1,
              'listen',
              'Listen to the reciter read lines $lineRange of $pageRef carefully.',
              3,
              'times',
              'headphones',
            ),
            _step(
              2,
              'read_along',
              'Play the audio and read along out loud, matching the pace.',
              3,
              'times',
              'book_open',
            ),
            _step(
              3,
              'listen',
              'Listen once more with your eyes closed, trying to hear each word.',
              1,
              'times',
              'headphones',
            ),
            _step(
              4,
              'recite_memory',
              'Turn off audio and recite from memory.',
              targetReps.clamp(3, 10),
              'times',
              'brain',
            ),
            _step(
              5,
              'self_test',
              'Final recitation without any aid. You can do this!',
              1,
              'times',
              'check_circle',
            ),
          ...
          'estimatedMinutes': 25,
          'tips': [
            'Focus on the melody and rhythm of the recitation.',
        ...
        return {
          'steps': [
            _step(
              1,
              'read_solo',
              'Read lines $lineRange of $pageRef slowly, noting the position of each verse.',
              3,
              'times',
              'eye',
            ),
            _step(
              2,
              'listen',
              'Listen to the reciter while following along with your finger.',
              2,
              'times',
              'headphones',
            ),
            _step(
              3,
              'read_solo',
              'Read again, focusing on tricky words and their visual position.',
              2,
              'times',
              'book_open',
            ),
            _step(
              4,
              'recite_memory',
              'Close the Mushaf and recite, visualizing the page layout.',
              targetReps.clamp(3, 10),
              'times',
              'brain',
            ),
            _step(
              5,
              'self_test',
              'Final test: recite the passage once perfectly.',
              1,
              'times',
              'check_circle',
            ),
          ...
          'estimatedMinutes': 25,
          'tips': [
            'Visualize where each verse sits on the page.',
            'Pay attention to verse beginnings at line starts.',
          ],
        };
        ...
        return {
          'steps': [
            _step(
              1,
              'listen',
              'Listen to lines $lineRange of $pageRef while following in your Mushaf.',
              2,
              'times',
              'headphones',
            ),
            _step(
              2,
              'write',
              'Write out the verses by hand on paper or a whiteboard.',
              1,
              'times',
              'pencil',
            ),
            _step(
              3,
              'read_solo',
              'Read the passage while tracking each word with your finger.',
              3,
              'times',
              'book_open',
            ),
            ...
            _step(
              5,
              'self_test',
              'Final recitation — you know this!',
              1,
              'times',
              'check_circle',
            ),
          ...
          'estimatedMinutes': 30,
          'tips': [
            'Writing engages extra memory pathways.',
            'Use a physical Mushaf whenever possible.',
          ],
        };
        ...
        return {
          'steps': [
            _step(
              1,
              'read_solo',
              'Read lines $lineRange of $pageRef carefully.',
              3,
              'times',
              'book_open',
            ),
            _step(
              2,
              'recite_memory',
              'Recite from memory (3×3 method: read 3, recite 3).',
              3,
              'times',
              'brain',
            ),
            ...
            _step(
              4,
              'recite_memory',
              'Recite from memory again — feel the flow.',
              reps,
              'times',
              'brain',
            ),
            _step(
              5,
              'link_practice',
              'Connect these verses with the previous passage.',
              2,
              'times',
              'link',
            ),
            _step(
              6,
              'self_test',
              'Final recitation — from start to finish, no pauses.',
              1,
              'times',
              'check_circle',
            ),
          ...
          'estimatedMinutes': 30,
          'tips': [
            'The 3×3 method: Read 3x → Recite 3x → Read 2x → Final recite 3x.',
            'Consistency beats speed. Trust the reps.',
          ],
        };
    }
  }
    ...
    return {
      'steps': [
        _step(
          1,
          'recite_memory',
          'Recite pages $pageList from memory. Note any weak spots.',
          2,
          'times',
          'brain',
        ),
        _step(
          2,
          'read_solo',
          'Open any pages where you stumbled and review them.',
          2,
          'times',
          'book_open',
        ),
        _step(
          3,
          'recite_memory',
          'Final recitation of weak sections.',
          1,
          'times',
          'brain',
        ),
  ...
  Map<String, dynamic> _manzilRecipe(
    LearningPreference pref,
    List<int> pages,
    int juz,
  ) {
    ...
    return {
      'steps': [
        _step(
          1,
          'recite_memory',
          'Recite pages $pageList (Juz $juz) at a steady pace.',
          1,
          'times',
          'brain',
        ),
        _step(
          2,
          'review_meaning',
          'Reflect on the meaning of any verses that felt disconnected.',
          5,
          'minutes',
          'lightbulb',
        ),
      ...
      'estimatedMinutes': 10,
      'tips': [
        'Manzil review maintains your long-term retention. Consistency is key.',
      ],
    };
  }
