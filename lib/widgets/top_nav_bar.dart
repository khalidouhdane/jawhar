      ...
      child: Row(
        ...
        children: [
          ...
          TopRightNavBar(
            ...
            onNavMenuTapped: onNavMenuTapped,
...
class TopLeftNavBar extends StatelessWidget {
  final String readMode;
  final ValueChanged<String> onReadModeChanged;
  ...
  Widget build(BuildContext context) {
    ...
    final readLabel = l?.readingRead ?? 'Read';
    final translationLabel = l?.readingTranslation ?? 'Translation';
