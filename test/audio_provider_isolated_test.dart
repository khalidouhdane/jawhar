...
void main() {
  group('AudioProvider Isolated Playback Boundary Tests', () {
    test('Should continue playing if position is before the isolated verse end time', () {
    ...
    test('Should pause playback and reset flags when position reaches or exceeds isolated verse end time', () {
      final controller = MockAudioPlayerController();
      controller.playSingleVerseIsolated('2:255', 5000);
    ...
    test('Should pause playback and reset flags when position exceeds isolated verse end time', () {
      final controller = MockAudioPlayerController();
      controller.playSingleVerseIsolated('2:255', 5000);
