...
void main() {
  group('VerseRefFormatter Latin Numbers Tests', () {
    ...
    test('surahName formats simple name and English translation for English locale', () {
      expect(VerseRefFormatter.surahName(1, 'en'), 'Al-Fatihah (The Opening)');
    ...
    test('format formats references with the compound English name', () {
      expect(VerseRefFormatter.format('1:1', locale: 'en', tier: VerseRefFormat.compact), 'Al-Fatihah (The Opening) · 1');
    });
  });
}
