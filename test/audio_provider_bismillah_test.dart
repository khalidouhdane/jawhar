...
void main() {
  group('Dynamic Bismillah Gap Correction Tests', () {
    test(
      'Should apply correction when Bismillah is missing (Yasser al-Dosari case)',
      () {
        ...
        expect(
          corrected.first.timestampTo,
          equals(9690),
        ); // 12770 - 3080 = 9690
        expect(
          corrected[1].timestampFrom,
          equals(10110),
        ); // 13190 - 3080 = 10110
        expect(
          corrected.last.timestampTo,
          equals(10773620),
        ); // 10776700 - 3080 = 10773620
      },
    );

    test(
      'Should NOT apply correction when Bismillah is present (Mishary Alafasy case)',
      () {
    ...
    test(
      'Should NOT apply correction if discrepancy is unrelated to first verse Bismillah start',
      () {
        final timings = [
          MockVerseTiming(
            verseKey: '2:1',
